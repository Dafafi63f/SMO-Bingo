...
GOAL_ICON_REMAP: dict[str, str] = {
    ...
    "{{X}} Hammer Bro Moons": "smo/capturehammerbro.webp",
    ...
    "{{X}} Critter Moon[[s]]": "smo/lifeupgoomba.webp",
    "Activate {{X}} Ground-Pound Switches": "smgalaxy/groundpound_switch.webp",
    "Activate {{X}} P-Switches": "mkwo/p_switch.webp",
    ...
    "{{X}} Wooded Story Moons": "smo/storywooded.webp",
